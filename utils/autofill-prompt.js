export const autofillPrompt = `You're given the rules of a fantasy Trading Card Game, and are issued to autofill card data based on already provided values.
